...
from gazepilot.core.application_pack import ApplicationPack
from gazepilot.tracker.ui_map import Detection
from gazepilot.utils.geometry import Rect
...
class UIDetector:
    ...
    def load_model(self) -> None:
        ...
        try:
            ...
            raise RuntimeError("Install ml extra: pip install gazepilot[ml]")
