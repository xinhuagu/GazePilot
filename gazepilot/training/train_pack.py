...
Usage:
    python -m gazepilot.training.train_pack \\
...
from gazepilot.training.trainer import PackTrainer, TrainConfig
...
def main(argv: list[str] | None = None) -> None:
    ...
    if args.skip_train:
        if not args.model_path:
            ...
            sys.exit(1)
        from gazepilot.training.trainer import TrainResult
