...
def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(description="GazePilot: AI-driven screen automation")
    ...
    if args.command == "list-windows":
        ...
        from gazepilot.core.monitor import run_monitor
        ...
        from gazepilot.training.collector import run_collect
        ...
        from gazepilot.training.dataset_prep import main as prep_main

        prep_main([args.session_dir, "--split", str(args.split)])

    elif args.command == "train":
        from gazepilot.training.train_pack import main as train_main
...
def _resolve_region(args: argparse.Namespace):
    ...
    if args.window:
        from gazepilot.capture.window_finder import find_window, print_windows
