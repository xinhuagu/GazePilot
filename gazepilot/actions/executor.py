...
from gazepilot.actions.action_types import Action, ActionResult, ActionStatus, ActionType
from gazepilot.actions.coordinate_transform import CoordinateTransform
from gazepilot.tracker.ui_map import UIMap
from gazepilot.utils.geometry import Point
...
class ActionExecutor:
    ...
    def _do_action(self, action: Action, screen_pt: Point) -> None:
        ...
        try:
            ...
            raise RuntimeError("Install platform extra: pip install gazepilot[platform]")
