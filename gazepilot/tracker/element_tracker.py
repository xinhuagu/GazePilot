...
from gazepilot.capture.change_detector import ChangeLevel, ChangeResult
from gazepilot.tracker.ui_map import Detection, UIElement, UIMap, UIMapDiff
from gazepilot.utils.geometry import iou
