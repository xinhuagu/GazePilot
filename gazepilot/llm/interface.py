...
from gazepilot.actions.action_types import Action
from gazepilot.cursor.cursor_monitor import CursorState
from gazepilot.llm.formatters import format_state
from gazepilot.llm.parsers import parse_actions
from gazepilot.tracker.ui_map import UIMap

logger = logging.getLogger(__name__)

SYSTEM_PROMPT = """You are GazePilot, an AI that operates a software application by \
...
class LLMInterface:
    ...
    def _call_anthropic(self, prompt: str) -> str:
        try:
            ...
            raise RuntimeError("Install llm extra: pip install gazepilot[llm]")
