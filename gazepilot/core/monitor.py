...
Usage:
    ...
    gazepilot monitor --pack my_erp --window "Citrix"
...
from gazepilot.core.orchestrator import Orchestrator
from gazepilot.utils.timing import FPSCounter
    ...
    if pack_name:
        ...
        if pack is None:
            ...
            if available:
                ...
                print("No packs found. Run 'gazepilot train' first.")
            sys.exit(1)
