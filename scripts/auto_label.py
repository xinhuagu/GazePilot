...
def predict_image(
    processor, model, image: Image.Image, threshold: float = 0.25
) -> list[dict]:
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", type=str, default="", help="Labels output dir (default: sibling 'labels/' dir)")
