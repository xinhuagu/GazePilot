...
from screenpilot.core.application_pack import ApplicationPack
from screenpilot.tracker.ui_map import Detection
...
class UIDetector:
    ...
    def load_model(self) -> None:
        ...
        try:
            ...
            raise RuntimeError("Install ml extra: pip install screenpilot[ml]")
