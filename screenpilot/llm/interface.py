...
from screenpilot.actions.action_types import Action
from screenpilot.cursor.cursor_monitor import CursorState
from screenpilot.llm.formatters import format_state
from screenpilot.llm.parsers import parse_actions
from screenpilot.tracker.ui_map import UIMap

logger = logging.getLogger(__name__)

SYSTEM_PROMPT = """You are ScreenPilot, an AI that operates a software application by \
...
class LLMInterface:
    ...
    def _call_anthropic(self, prompt: str) -> str:
        try:
            ...
            raise RuntimeError("Install llm extra: pip install screenpilot[llm]")
