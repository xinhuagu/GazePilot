...
def main(argv: list[str] | None = None) -> None:
    ...
    if args.command == "list-windows":
        ...
        from screenpilot.training.dataset_prep import main as prep_main
...
def _resolve_region(args: argparse.Namespace):
    ...
    from screenpilot.config import CaptureRegion

    if args.window:
        from screenpilot.capture.window_finder import find_window, print_windows
