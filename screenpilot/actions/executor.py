...
from screenpilot.actions.action_types import Action, ActionResult, ActionStatus, ActionType
from screenpilot.actions.coordinate_transform import CoordinateTransform
from screenpilot.tracker.ui_map import UIMap
from screenpilot.utils.geometry import Point
...
class ActionExecutor:
    ...
    def _do_action(self, action: Action, screen_pt: Point) -> None:
        ...
        try:
            ...
            raise RuntimeError("Install platform extra: pip install screenpilot[platform]")
