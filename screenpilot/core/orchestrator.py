...
from screenpilot.actions.coordinate_transform import CoordinateTransform
from screenpilot.actions.executor import ActionExecutor
from screenpilot.capture.change_detector import ChangeDetector
from screenpilot.capture.screen_capture import ScreenCapture
...
from screenpilot.cursor.cursor_monitor import CursorMonitor
from screenpilot.detection.detector import UIDetector
from screenpilot.tracker.element_tracker import ElementTracker
...
class Orchestrator:
    ...
    def __init__(self, config: ScreenPilotConfig):
        self.config = config
