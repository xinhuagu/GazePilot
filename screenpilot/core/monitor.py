...
Usage:
    ...
    screenpilot monitor --pack my_erp --window "Citrix"
...
from screenpilot.core.orchestrator import Orchestrator
from screenpilot.utils.timing import FPSCounter
    ...
    if pack_name:
        ...
        if pack is None:
            ...
            if available:
                ...
                print("No packs found. Run 'screenpilot train' first.")
            sys.exit(1)
